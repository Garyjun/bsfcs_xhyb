...
public class Convert {
    ...
    private static final Option OPTION_PORT = new Option("p", "port", true, "office socket port (optional; defaults to " + Integer.parseInt(PropertiesReader.getInstance().getProperty("openOfficePort")) +")");
    ...
    private static final int DEFAULT_OFFICE_PORT = Integer.parseInt(PropertiesReader.getInstance().getProperty("openOfficePort"));
...
//        }
        ...
        try {
            if (outputFormat == null) {
                ...
                converter.convert(inputFile, outputFile,0);
            } else {

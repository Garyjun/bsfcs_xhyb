...
public class OfficeDocumentConverter {
    ...
    public void convert(File inputFile, File outputFile,int threadNum) throws OfficeException {
        ...
        convert(inputFile, outputFile, outputFormat,threadNum);
    }

    public void convert(File inputFile, File outputFile, DocumentFormat outputFormat,int threadNum) throws OfficeException {
        String inputExtension = FilenameUtils.getExtension(inputFile.getName());
        DocumentFormat inputFormat = formatRegistry.getFormatByExtension(inputExtension);
        StandardConversionTask conversionTask = new StandardConversionTask(inputFile, outputFile, outputFormat,threadNum);
